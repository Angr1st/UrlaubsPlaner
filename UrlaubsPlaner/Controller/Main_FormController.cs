...
{
    public class Main_FormController : UrlaubsPlaner_FormControllerBase
    {
        public bool Initialized
        {
            get { return Employee_FormController != null && AbsenceType_FormController != null; }
        }
        ...
        private Employee_FormController Employee_FormController;
        private AbsenceType_FormController AbsenceType_FormController;
        ...
        public (AbsenceType_FormController absenceType_FormController,Employee_FormController employee_FormController) Initialize()
        {
            if (!Initialized)
            {
            ...
            return (AbsenceType_FormController, Employee_FormController);
        }

        public void Run() => Application.Run(Main_Form);
